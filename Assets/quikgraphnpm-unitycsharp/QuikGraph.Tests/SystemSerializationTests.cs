...
namespace QuikGraph.Tests.Serialization
{
    ...
    internal class SystemSerializationTests
    {
        ...
        public void BinarySerialization_BidirectionalGraph( BidirectionalGraph<int, EquatableEdge<int>> graph)
        {
        ...
        public void BinarySerialization_UndirectedGraph( UndirectedGraph<int, EquatableEdge<int>> graph)
        {
