...
/// <summary>
///     Instantiates a <see cref="BitHelper"/> with a heap
///     alloc'd array of ints.
/// </summary>
/// <param name="bitArrayPtr">
///     int array to hold bits.</param>
/// <param name="length">
///     length of int array.
/// </param>
        [SecurityCritical]
...
/// <summary>
///     Instantiates a <see cref="BitHelper"/>
///     with a heap alloc'd array of ints.
/// </summary>
/// <param name="bitArray">
...
/// <summary>
///     How many ints must be allocated to represent n bits.
///     Returns (n+31)/32, but avoids overflow.
/// </summary>
